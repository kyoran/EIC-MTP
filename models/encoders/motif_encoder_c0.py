...
class Motif_Encoder_C0(PredictionEncoder):
    ...
    def forward(self, inputs, is_test=False):
        ...
        target_agent_enc = torch.cat((target_agent_enc, target_agent_enc), dim=1)
        
        nbr_veh_enc = torch.cat((nbr_veh_enc, nbr_veh_enc), dim=2)
        nbr_ped_enc = torch.cat((nbr_ped_enc, nbr_ped_enc), dim=2)
