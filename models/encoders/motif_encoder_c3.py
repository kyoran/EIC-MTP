...
class Motif_Encoder_C3(PredictionEncoder):
    ...
    def forward(self, inputs, is_test=False, is_val=False):
        ...
        if is_val:
            explicit_rel_all_t, explicit_rel_agg, latent_rel, max_dis = self.extract_relationship(
        ...
        if is_test:
            ...
            return encodings, nbr_num, max_dis
    ...
    def extract_relationship(self,
        ...
        if is_val:
            return None, None, LRs, max_dis
        else:
            return None, None, LRs
