...
class Motif_Agg_V5(PredictionAggregator):
    """
    ...
    def forward(self, encodings: Dict) -> Dict:
        ...
        # Unpack encodings:
        target_agent_encoding = encodings['target_agent_encoding']    # [32, 64]
        node_encodings = encodings['context_encoding']['v2l_combined']    # [32, 164, 32]
        node_masks = encodings['context_encoding']['v2l_combined_masks']    # [32, 164]
        s_next = encodings['s_next']        # [32, 164, 15]
        edge_type = encodings['edge_type']  # [32, 164, 15]
        ...
        # sampled_traversals: [32, 1000, 15]
        # node_encodings: [32, 164, 32]
        # target_agent_encoding: [32, 64]
    ...
    def aggregate(self, sampled_traversals, node_encodings, target_agent_encoding) -> torch.Tensor:
        ...
        agg_enc = torch.cat(
            (target_agent_encoding.unsqueeze(1).repeat(1, self.num_samples, 1), att_op), dim=-1)
